			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3 logo_agile mb-4">
					<h1 class="text-center">
						<a href="${pageContext.request.contextPath}/home" class="font-weight-bold font-italic" style="font-size: 35px;">
							<img src="${pageContext.request.contextPath}/images/logo2.png" class="img-about">&nbsp;
						</a>
					</h1>
				</div>
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="/product/search" method="post">
								<input class="form-control mr-sm-2" type="search" name="keyword" placeholder="Search your product..." aria-label="Search" required>
