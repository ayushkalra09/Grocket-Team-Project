			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">Grocket
							<label style="font-weight: bold;color:black;">General Store, Bits-Pilani, Hyderabad-500078</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+919315181836">+(91) 9315181836</a>
						
<!-- 							<label>+(91) 9315181836</label> -->
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:javahub018@gmail.com">supriyam.agarwal@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
